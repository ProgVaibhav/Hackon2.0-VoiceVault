...
def voiceverificationlogin():
        ...
        b2.place(x=94, y=545)
        b3 = Button(loginwindow, text="NEW TO VOICEVAULT? REGISTER TO VOICEVAULT", width="40", fg="#1E1D6C", highlightthickness = 0,relief = FLAT, bd = 0, borderwidth=0,font = ('Arial',9,'bold'), bg="white",activebackground ="white", command=switchwin5)
        b3.place(x=94, y=560)
...
def signinmanual():
        ...
        b2 = Button(mloginwindow, text="LOGIN USING VOICE VERIFICATION METHOD", width="38", fg="#1E1D6C", highlightthickness = 0,relief = FLAT, bd = 0, borderwidth=0,font = ('Arial',9,'bold'), bg="white", command=switchwin1)
        b2.place(x=94, y=430)
...
def home(username):
    ...
    def upload_file(fileurl):
        ...
        if (file_ext == "jpg" or file_ext == "png" or file_ext == "jpeg"):
            copyfile(filename, "c:/ProgramData/VoiceVault/localdata/" + filename)
    ...
    def getImageFile(filename):
        ...
        copyfile("C:/ProgramData/VoiceVault/localdata/" + filename, D_path + filename)
    ...
    def upload():
        ...
        b = Button(window, text="Upload File", width=20, bg="#EEFBFB", highlightthickness=0, font=('Calibiri', 24, 'bold'),
                   bd=0, fg="#203647", activebackground="#4DA8DA", command=lambda: upload_file(filename))
        b.place(x=250, y=450)
    ...
    def about():
        canvas = Canvas(window, height=800, width=847, highlightthickness=0, bd=0, bg='#203647')
        imgq = Image.open(ImagePath+"about.png")
